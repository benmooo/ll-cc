...
import { XiangqiBoard } from "~/components/cc-board";
import {
  START_POSITION,
  PositionObject,
  Square,
  ...
  return (
    <main class="min-h-screen flex flex-col items-center justify-center bg-amber-50">
      ...
      <div class="flex space-x-3">
        <button class="border p-2" onClick={resetBoard}>Reset Board</button>
        <button class="border p-2" onClick={flipBoard}>Flip Board</button>
      </div>
      <div>
